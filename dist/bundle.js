...
const observable = getSymbolObservable(_root);
/**
...
const iterator = symbolIteratorPonyfill(_root);
/**
...
const Set = _root.Set || minimalSetImpl();
...
const Map = _root.Map || (() => MapPolyfill)();
